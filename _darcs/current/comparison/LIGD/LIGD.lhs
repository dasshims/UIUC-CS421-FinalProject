...
> import TreeDatatype -- needed to define RWTree, see below
...
The following representation is added for the RmWeights test.
We allow cheating (adding a constructor to |Rep|) because the
user might want to pay the price of losing separate compilation
to get constructor cases.

>                               |  forall aT bT . RWTree (Rep aT) (Rep bT) (EPT tT (WTree aT bT))
...
Representation for generic functions of arity 2

> data Rep2 fT aT bT            =  RInt2    (EPT aT Int) (EPT bT Int)
...
>                                  RArrow2 (Rep2 fT aT1 bT1) (Rep2 fT aT2 bT2)
>                                          (EPT aT (aT1 -> aT2)) (EPT bT (bT1 -> bT2))
>                               |  RUnit2   (EPT aT UnitT) (EPT bT UnitT)
>                               |  forall aT1 aT2 bT1 bT2 .
>                                  RSum2 (Rep2 fT aT1 bT1) (Rep2 fT aT2 bT2)
>                                        (EPT aT (Sum aT1 aT2)) (EPT bT (Sum bT1 bT2))
>                               |  forall aT1 aT2 bT1 bT2 .
>                                  RPair2 (Rep2 fT aT1 bT1) (Rep2 fT aT2 bT2)
>                                         (EPT aT (Pair aT1 aT2)) (EPT bT (Pair bT1 bT2))
>                               |  forall aT' bT' .
>                                  RType2 Term   (Rep2 fT aT' bT') (EPT aT aT') (EPT bT bT')
>                               |  RCon2  String (Rep2 fT aT bT)
>                               |  RVar2  (fT aT bT)

> rInt2                          :: Rep2 fT Int Int
> rInt2                          =  RInt2         self self

> rChar2                         :: Rep2 fT Char Char
> rChar2                         =  RChar2        self self

> rDynamic2                      :: Rep2 fT Dynamic Dynamic
> rDynamic2                      =  RDynamic2     self self

> rArrow2                        :: forall fT aT bT.
>                                   Rep2 fT aT bT->
>                                   (forall aT' bT' .
>                                    Rep2 fT aT' bT' ->
>                                    Rep2 fT (aT -> aT') (bT -> bT')
...
> rUnit2                         :: Rep2 fT UnitT UnitT
> rUnit2                         =  RUnit2        self self

> rSum2                          :: forall fT aT bT.
>                                   Rep2 fT aT bT->
>                                   (forall aT' bT' .
>                                    Rep2 fT aT' bT'->
>                                    Rep2 fT (Sum aT aT') (Sum bT bT')
>                                   )
> rSum2   rA rB                  =  RSum2   rA rB self self

> rPair2                         :: forall fT aT bT.
>                                   Rep2 fT aT bT->
>                                   (forall aT' bT' .
>                                    Rep2 fT aT' bT'->
>                                    Rep2 fT (Pair aT aT') (Pair bT bT')
>                                   )
> rPair2  rA rB                  =  RPair2  rA rB self self

> rFloat2                        :: Rep2 fT  Float Float
...
> term2                          :: forall fT aT bT . Rep2 fT aT bT -> Term
...
> rList2                         :: forall aT bT fT . Rep2 fT aT bT -> Rep2 fT [aT] [bT]
