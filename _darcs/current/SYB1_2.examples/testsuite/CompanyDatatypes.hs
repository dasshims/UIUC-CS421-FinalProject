...
data Company  = C [Dept]               deriving (Eq, Read, Show, Typeable, Data)               
data Dept     = D Name Manager [Unit]  deriving (Eq, Read, Show, Typeable, Data)
data Unit     = PU Employee | DU Dept  deriving (Eq, Read, Show, Typeable, Data)
data Employee = E Person Salary        deriving (Eq, Read, Show, Typeable, Data)
data Person   = P Name Address         deriving (Eq, Read, Show, Typeable, Data)
data Salary   = S Float                deriving (Eq, Read, Show, Typeable, Data)                  
