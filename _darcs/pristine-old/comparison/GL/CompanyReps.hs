...
class Generic g => GenericCompany g where
  company  :: g Company
  company  =  view isoCompany (constr "C" 1 (rList dept))
  dept     :: g Dept
  dept     =  view isoDept (constr "D" 3 (rList char <*> employee <*> rList unit'))
  unit'    :: g Unit
  unit'    =  view isoUnit (constr "PU" 1 employee <|> constr "DU" 1 dept)
  employee :: g Employee
  employee =  view isoEmployee (constr "E" 2 (person <*> salary))
  person   :: g Person
  person   =  view isoPerson (constr "P" 2 (rList char <*> rList char)) 
  salary   :: g Salary
