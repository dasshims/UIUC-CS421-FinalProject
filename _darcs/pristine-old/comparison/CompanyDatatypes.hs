...
data Company  = C [Dept]               deriving (Show, Typeable, Data)
data Dept     = D Name Manager [Unit]  deriving (Show, Typeable, Data)
data Unit     = PU Employee | DU Dept  deriving (Show, Typeable, Data)
data Employee = E Person Salary        deriving (Show, Typeable, Data)
data Person   = P Name Address         deriving (Show, Typeable, Data)
data Salary   = S Float                deriving (Show, Typeable, Data)
